...
class PorticusGallerySitemap(Sitemap):
    ...
    def location(self, obj):
        return reverse('porticus-gallery-detail', kwargs={'detail_slug': obj.slug})
...
class PorticusAlbumSitemap(Sitemap):
    ...
    def location(self, obj):
        return reverse('porticus-album-detail', kwargs={'parent_slug': obj.gallery.slug, 'detail_slug': obj.slug})
